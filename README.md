About nvidia-modulus-feedstock
==============================
...
Development: https://github.com/NVIDIA/modulus
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/nvidia-modulus-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/nvidia-modulus-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add nvidia-modulus
# for installing globally
pixi global install nvidia-modulus
```
...
It is possible to list all of the versions of `nvidia-modulus` available on your platform:
...
```
pixi search nvidia-modulus --channel conda-forge
```
